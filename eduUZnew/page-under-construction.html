          ...
          <div class="container pt-0 pb-0">
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                <h1 class="font-weight-300 text-theme-colored2 font-64 mb-0">Under Construction</h1>
                <form id="mailchimp-subscription-form" class="newsletter-form mt-0 mb-30 maxwidth500">
                  ...
                  <div class="input-group">
                    ...
                    <span class="input-group-btn">
                      <button type="submit" class="btn btn-colored btn-theme-colored2 text-white btn-xs m-0" data-height="45px">Subscribe</button>
                    </span>
                  </div>
                </form>
